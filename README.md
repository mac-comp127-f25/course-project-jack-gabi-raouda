...
This is a fishing game, where the user moves a boat left and right and presses the space bar to catch fish. The goal is to 
catch all the fish while avoiding sharks. 
